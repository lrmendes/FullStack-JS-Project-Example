...
export default function Detail() {
    ...
    const message = `Hi, ${incident.name}, I am contating you because I want to help in the case of "${incident.title}" with the amount of ${Intl.NumberFormat('pt-BR', { style: 'currency', currency: 'BRL' }).format(incident.value).replace(/^(\D+)/, '$1 ')}.`;
    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.incident}>
                    <View style={styles.incidentColumn}>
                        <Text style={[styles.incidentProperty, {marginTop: 0} ]}>ONG: </Text>
                        <Text style={[styles.incidentProperty, {marginTop: 0} ]}>City: </Text>
                    </View>
                    <View style={styles.incidentColumn}>
